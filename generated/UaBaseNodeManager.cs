...
{
    internal partial class UaBaseNodeManager : BaseNodeManager
    {
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public UaBaseNodeManager(ServerManager server) : base(server)
        {
        }
        #endregion
        ...
        public override void Startup()
        {
            try
            {
                Console.WriteLine("Starting UaBaseNodeManager.");

                DefaultNamespaceIndex = AddNamespaceUri("http://opcfoundation.org/UA/Machinery/");

                Console.WriteLine("Loading the UaBase Model.");
                ImportUaNodeset(Assembly.GetEntryAssembly(), "Opc.Ua.Machinery.NodeSet2.xml");
            }
            catch (Exception e)
            {
                Console.WriteLine("Failed to start UaBaseNodeManager " + e.Message);
            }
        }
        ...
        public override void Shutdown()
        {
            try
            {
                Console.WriteLine("Stopping UaBaseNodeManager.");

                // TBD
            }
            catch (Exception e)
            {
                Console.WriteLine("Failed to stop UaBaseNodeManager " + e.Message);
            }
        }
        #endregion
